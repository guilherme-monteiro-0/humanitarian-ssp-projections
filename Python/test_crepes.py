...
print("Binary classification rf: ", eval)

# Gradient Boosting
rf = WrapClassifier(HistGradientBoostingClassifier(validation_fraction=None, max_iter=1500, max_depth=None, learning_rate=0.01))
...
print("Binary classification gb: ", eval)
